...
<div style="text-align: justify;">
    <p class=MsoNormal style='text-align:justify;text-indent:.5in;line-height:190%'><span
            ...
            has been returned this <b>{{ \Carbon\Carbon::parse($appearanceCert->returnedDate)->format('F j, Y') }}</b>, in
...
style='font-size:12.0pt;line-height:50%;font-family:"Arial",sans-serif'><u><b>{{ mb_strtoupper($appearanceCert->complainantfname) }} @if (!empty($appearanceCert->complainantmname)){{ mb_strtoupper(substr($appearanceCert->complainantmname, 0, 1)) }}. @endif{{ mb_strtoupper($appearanceCert->complainantlname) }} {{ mb_strtoupper($appearanceCert->complainantsuffix) }}</b></u>
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span><![endif]><span
style='font-size:12.0pt;line-height:50%;font-family:"Arial",sans-serif'><u><b>{{ mb_strtoupper($appearanceCert->legalDivisionChief) }}</b></u>
(Chief, Legal Division)</span></p>

...
<b>{{ $complaintsCert->fname }} {{ $complaintsCert->mname }} {{ $complaintsCert->lname }}@if(!empty($complaintsCert->suffix)) {{ mb_strtoupper($complaintsCert->suffix) }}@else.@endif</b>, a <b>{{ mb_strtoupper($complaintsCert->profession->profession) }} </b>with Registration No.

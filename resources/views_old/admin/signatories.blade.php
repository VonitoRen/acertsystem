                            ...
                            <table id="datatable1" class="display" style="width:100%;">
                                ...
                                <tbody>
                                    ...
                                    @foreach($uniquePersons as $personRole)
                                        <tr>
                                            ...
                                            <td>
                                                <div class="btn-group" role="group" aria-label="Actions">
                                                    <!-- Edit Button -->
                                                    <!-- <a href="" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#editCertificateModal{{ $personRole->person_id }}">
                                                        <i class="fas fa-edit"></i>
                                                    </a> -->
                                                    <form id="deleteForm{{ $personRole->id }}" action="{{ route('delete.signatories', $personRole->id) }}" method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                        ...
                                        <div class="modal fade" id="editCertificateModal{{ $personRole->person_id }}" tabindex="-1" aria-labelledby="editCertificateModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-lg modal-dialog-centered">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="{{ route('update.signatories', $personRole->person_id) }}" method="post">
                                                        @csrf
                                                        @method('PUT')
                                                        <div class="modal-body">
                                                            <div class="container">

                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                ...
                                <div class="row">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-2">
                                                <input type="text" class="form-control" style="border-radius: 5px; border-color: lightgrey;" id="signatoriesAtty" name="signatoriesAtty" placeholder="Hearing Officer, Legal Division">
                                                <label for="signatoriesAtty">Attorney</label>
                                                <div class="valid-feedback">
                                                You got this officer!
                                                </div>
                                                <div class="invalid-feedback">
                        ...
                        @method('PUT')
                                <div class="modal-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-2">
                                                <input type="text" class="form-control" style="border-radius: 5px; border-color: lightgrey;" id="hearing_officer" name="hearing_officer" placeholder="Hearing Officer, Legal Division" value="{{ $cert->hearing_officer }}">

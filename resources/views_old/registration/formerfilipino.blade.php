                            ...
                            <div class="modal-dialog modal-dialog-centered modal-lg">
                                ...
                                <div class="container">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-floating mb-2">
                                                <input type="text" class="form-control" style="border-radius: 5px; border-color: lightgrey;" id="licenseNo" name="licenseNo" placeholder="COR/PLN No." maxlength="7" required>
                                                <label for="licenseNo">COR/PLN No.</label>
                                                <div class="valid-feedback">
                                                    Sheeesh!
                                                </div>
                                                <div class="invalid-feedback">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-floating mb-2">
                                                ...
                                                <label for="dateIssued">COR/PLN Date Issued</label>
                                                <div class="valid-feedback">
                                                    Amazing!
                                                </div>
                                                <div class="invalid-feedback">

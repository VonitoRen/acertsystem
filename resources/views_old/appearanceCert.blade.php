...
<link rel=File-List href="CERTIFICATE%20OF%20APPEARANCE_files/filelist.xml">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:Created>2024-03-14T05:24:00Z</o:Created>
  <o:LastSaved>2024-03-14T05:46:00Z</o:LastSaved>
  <o:Pages>1</o:Pages>
  <o:Words>76</o:Words>
...
<link rel=themeData href="CERTIFICATE%20OF%20APPEARANCE_files/themedata.thmx">
<link rel=colorSchemeMapping
href="CERTIFICATE%20OF%20APPEARANCE_files/colorschememapping.xml">
<!--[if gte mso 9]><xml>
 <w:WordDocument>
...
<p class=MsoNormal align=center style='text-align:center'><b><span
style='font-size:16.0pt;line-height:107%'>CERTIFICATE OF APPEARANCE<o:p></o:p></span></b></p>



<p class=MsoNormal><b><span style='font-size:13.0pt;line-height:107%'>TO WHOM
...
@endif
{{ mb_strtoupper($appearanceCert->lname) }}@if(!empty($appearanceCert ->suffix)) {{ mb_strtoupper($appearanceCert ->suffix) }} @endif</b>of {{ mb_strtoupper($appearanceCert->agency) }} personally appeared in this Office on {{ \Carbon\Carbon::parse($appearanceCert->dateOfAppearance)->format('F j, Y') }} for {{ $appearanceCert->purpose }}.</span>
</p>
...
<p class=MsoNormal><o:p>&nbsp;</o:p></p>
<p class=MsoNormal><o:p>&nbsp;</o:p></p>
<p class=MsoNormal style='font-size:10.0pt;'> <i>CAR-CA-2024-{{ str_pad($appearanceCert->id, 5, '0', STR_PAD_LEFT) }}</i></p>

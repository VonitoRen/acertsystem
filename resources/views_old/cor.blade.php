...
margin-left:.5in'><span style='font-size:13.0pt;line-height:107%;margin-left: 0.5in;'>{{ $certificationOfRegistrations->placeOfIssue }}</span></p>

<p class=MsoNormal style='margin-top:0in;margin-right:0in;margin-bottom:0in;
margin-left:.5in'><span style='font-size:13.0pt;line-height:107%;margin-left: 0.5in;'>{{ \Carbon\Carbon::parse($certificationOfRegistrations->date_issues)->format('F j, Y') }}<o:p></o:p></span></p>

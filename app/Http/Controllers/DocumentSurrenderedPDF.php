...
class DocumentSurrenderedPDF extends Controller
{
   
    // public function previewPdf($id)
    // {
    //     // Get the specific certification record by ID
    //     $surrenderedCert = SurrenderedDocuments::findOrFail($id);
    ...
    //     $html = view('documentSurrendered', compact('surrenderedCert', 'imageUrl'))->render();
    ...
    //     return view('preview-surrendered-pdf', compact('base64Pdf'));
    // }
